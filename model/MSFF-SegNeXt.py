...
from modules import EGA, make_laplace_pyramid, make_sobel_pyramid
import bricks
...
class LightHamHead(nn.Module):
    ...
    def __init__(
        ...
        self.egan = EGA(in_channels=out_channels)
    ...
    def forward(self, inputs):
        ...
        o = inputs[0]
        """-----sobel&EGA-----"""
        grayscale_imgs = rgb_to_grayscale(o)
        sobel_pyramid = make_sobel_pyramid(grayscale_imgs, 5, 1)
        edge_feature = sobel_pyramid[1]
        ...
        egan = self.egan(edge_feature, inputs[2], out)
        out = torch.cat([out, egan], dim=1)
